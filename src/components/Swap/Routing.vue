<template>
  <div>
    ...
    <div v-if="visible" class="body">
      <div v-if="routes.length === 0" class="no-data-label">
        No data available
      </div>
      <div v-else>
        <div class="pair">
        ...
        <div class="arrows" :style="{ margin: `8px ${11 + routes.length}px` }">
          <Icon :title="'triangle'" class="arrow-icon" />
          <Icon :title="'triangle'" class="arrow-icon reverted" />
        </div>
        <div class="routes">
          <div
          ...
          <div class="route-wrapper">
            ...
            >
              <div class="arrow-wrapper">
                <Icon :title="'triangle'" class="arrow-icon horizontal" />
              </div>
              <div class="hops">
                <div
