<template>
  <ModalBase :title="'Select Asset'" :open="open" @close="close">
    <template #default>
      ...
      >
        <div class="asset-meta">
          <AssetIcon class="asset-icon" :address="asset.address" />
          <div class="asset-symbol">
            {{ asset.symbol }}
          </div>
          <div v-if="isIncompatible(asset.address)" class="asset-incompatible">
            Incompatible
          </div>
        </div>
